...
declare const _default: {
     ...
     * @version v0.1.2+
     */
    registerWithBlurView(data: ScreenGuardData.ScreenGuardBlurDataObject): Promise<void>;
    /**
     * activate with an Image uri (iOS 13+, Android 8+)
     * @param data ScreenGuardImageDataObject data object,
     * @version v1.0.2+
     */
    registerWithImage(data: ScreenGuardData.ScreenGuardImageDataObject): Promise<void>;
    /**
     ...
     * @version v0.3.6+
     */
    registerScreenshotEventListener(getScreenShotPath: boolean, callback: (data?: ScreenGuardData.ScreenGuardScreenShotPathDataObject | null | undefined) => void): () => void;
    /**
     * Screen recording event listener (iOS only)
     * Register for screen recording event listener
     * @version v0.3.6+
     */
    registerScreenRecordingEventListener(getScreenRecordStatus: boolean, callback: (data?: ScreenGuardData.ScreenGuardScreenRecordDataObject | null | undefined) => void): (() => void) | undefined;
    /**
